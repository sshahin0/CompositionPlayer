...
class OceanLife: BCMTransitionTemplate {
    ...
    override func setup() {
        videoItems = [BCMVideoItem(name: "line_5_1"),BCMVideoItem(name: "line_5_0")]

        videoTransition = BCMVideoTransition(video: videoItems.first!)
